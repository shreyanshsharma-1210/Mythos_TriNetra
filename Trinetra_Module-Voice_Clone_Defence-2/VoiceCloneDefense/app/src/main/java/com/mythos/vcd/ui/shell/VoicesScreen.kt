...
import com.mythos.vcd.data.EnrolledContact
import com.mythos.vcd.pipeline.Fusion
import com.mythos.vcd.ui.components.InfoCard
import com.mythos.vcd.ui.components.MinTouchTarget
import com.mythos.vcd.ui.components.SectionTitle
import com.mythos.vcd.ui.components.VcdHeader
import com.mythos.vcd.ui.components.VcdIconButton
import com.mythos.vcd.ui.components.VcdListRow
import com.mythos.vcd.ui.permission.hasMicPermission
...
fun VoicesScreen(
    ...
    Column(modifier.fillMaxSize()) {
        ...
        LazyColumn(Modifier.fillMaxSize()) {
            if (modelStatus is com.mythos.vcd.ml.ModelRuntime.Status.Unavailable) {
                item {
                    InfoCard("Voice models are not available", accent = StatusColors.critical) {
                        Text(
                            (modelStatus as com.mythos.vcd.ml.ModelRuntime.Status.Unavailable).message,
